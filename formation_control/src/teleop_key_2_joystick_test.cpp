...
#define PI 3,1415926535897932384
	...
	int num, test2, perp=0;
        double xom=-6.0, yom=-4.2, zom=4.8;
        int formation =1;
	int left=0, right=0;
	double pend;
	int robot;
...
void keyLoop()
{
	...
	if (((x_real_pos[0]>7.575)&(x_real_pos[0]<17.575))&(y_real_pos[0]>16.85))
	{
...
//	std::cout << "sei qu? 1 " << std::endl;
	...
	f_follow=1;
	angle=1;
	//std::cout << "Riallineando il robot prima di curvare..attendi..." << std::endl;
	alpha_rot = 30.0;
	c=13;} //90.0
        else {c=2;}
